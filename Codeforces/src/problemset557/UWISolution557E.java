...
//				tr(head, tail, new String(s, head, tail-head+1), lc, len);
                if(lc >= len){
...
//					tr(i, le);
    ...
    public static void main(String[] args) throws Exception { new UWISolution557E().run(); }
